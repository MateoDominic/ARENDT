const btnClick = document.querySelector("#btnRegistracija"); //treba dodati u html ako se bude mjenjao 
...
const lastName = document.querySelector("#exampleInputSurname1"); 
